...
const swconf = {
  {% if site.pwa.cache.enabled %}
    ...
    interceptor: {
      ...
      urlPrefixes: [
        // START of changes for GoatCounter
        'https://gc.zgo.at',
        {% if site.analytics.goatcounter.id != nil and site.pageviews.provider == 'goatcounter' %}
          'https://{{ site.analytics.goatcounter.id }}.goatcounter.com',
        {% endif %}
        'https://0620.goatcounter.com' // Specifically for your counter API endpoint
        // END of changes
      ]
    },
